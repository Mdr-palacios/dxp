...
{language_directive}{ab_directive}━━━ HARD CONSTRAINT — READ CAREFULLY ━━━
...
"""
    ...
    for key, label in FORMAT_LABELS.items():
        ...
        formatted_outputs.append(
            ...
            f"| RESEARCH DATE: {most_recent_date}{lang_tag}{ab_tag} ---\n"
    ...
    logger.info(
        ...
        f"for {district_label} in {language_name} (ab_test={ab_test}) using "
        f"research dated as recently as {most_recent_date}."
    )
